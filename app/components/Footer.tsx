          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-amber-400">
                <span className="text-sm font-bold text-black">FT</span>
              </div>
            ...
            <div className="mt-6 space-y-3">
              <a
                ...
                className="flex items-center gap-3 text-sm text-white/55 transition-colors hover:text-amber-300"
              >
                <svg
            ...
            <div className="mt-7 flex items-center gap-3">
              ...
              <a
                ...
                aria-label="WhatsApp"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/60 transition-all hover:border-amber-400/50 hover:bg-amber-400/10 hover:text-amber-300"
              >
