...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 bg-white/40 backdrop-blur-md text-black">
      {/* Main Grid */}
      <div className="mx-auto max-w-[1300px] px-6 py-16 md:px-10 lg:px-14">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-black">
              Pakistan&apos;s trusted luxury travel partner for Hajj, Umrah,
              international holidays, domestic expeditions, and complete visa
              assistance.
            </p>
            ...
            <div className="mt-6 space-y-3">
              <a
                ...
                className="flex items-center gap-3 text-sm text-black transition-colors hover:text-[#5409DA]"
              >
                <svg
                  className="h-4 w-4 shrink-0 text-[#5409DA]/80"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1.8"
                  viewBox="0 0 24 24"
              ...
              <a
                href="mailto:info@fatimatravels.pk"
                className="flex items-center gap-3 text-sm text-black transition-colors hover:text-[#5409DA]"
              >
                <svg
                  className="h-4 w-4 shrink-0 text-[#5409DA]/80"
            ...
            <div className="mt-7 flex items-center gap-3">
              ...
              <a
                ...
                aria-label="WhatsApp"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-300 bg-white/50 text-black transition-all hover:border-[#5409DA]/50 hover:bg-blue-50 hover:text-[#5409DA]"
              >
